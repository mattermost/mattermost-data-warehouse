def test_create_alert_body(config_alert_context):
    ...
    assert (
        '**Task**: [test_task](https://airflow.internal.mattermost.com/task?dag_id=test_utils_dag&task_id=test_task&execution_date=2022-11-15T00%3A00%3A00%2B00%3A00)'  # noqa: E501
        in body
    )
