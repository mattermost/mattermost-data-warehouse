...
AWS_SECRET_ACCESS_KEY = Secret("env", "AWS_SECRET_ACCESS_KEY", "airflow", "AWS_SECRET_ACCESS_KEY")

# dbt Cloud
DBT_CLOUD_API_KEY = Secret("env", "DBT_CLOUD_API_KEY", "airflow", "DBT_CLOUD_API_KEY")
DBT_CLOUD_API_ACCOUNT_ID = Secret("env", "DBT_CLOUD_API_ACCOUNT_ID", "airflow", "DBT_CLOUD_API_ACCOUNT_ID")

# Snowflake Load
SNOWFLAKE_LOAD_DATABASE = Secret("env", "SNOWFLAKE_LOAD_DATABASE", "airflow", "SNOWFLAKE_LOAD_DATABASE")
SNOWFLAKE_LOAD_ROLE = Secret("env", "SNOWFLAKE_LOAD_ROLE", "airflow", "SNOWFLAKE_LOAD_ROLE")
...
SNOWFLAKE_LOAD_WAREHOUSE = Secret("env", "SNOWFLAKE_LOAD_WAREHOUSE", "airflow", "SNOWFLAKE_LOAD_WAREHOUSE")

# Snowflake Transform
SNOWFLAKE_TRANSFORM_ROLE = Secret("env", "SNOWFLAKE_TRANSFORM_ROLE", "airflow", "SNOWFLAKE_TRANSFORM_ROLE")
SNOWFLAKE_TRANSFORM_SCHEMA = Secret("env", "SNOWFLAKE_TRANSFORM_SCHEMA", "airflow", "SNOWFLAKE_TRANSFORM_SCHEMA")
...
NPS_WEBHOOK_URL = Secret("env", "NPS_WEBHOOK_URL", "airflow", "NPS_WEBHOOK_URL")
DOCS_WEBHOOK_URL = Secret("env", "DOCS_WEBHOOK_URL", "airflow", "DOCS_WEBHOOK_URL")

# Permission Bot
PERMISSION_BOT_USER = Secret("env", "PERMISSION_BOT_USER", "airflow", "SNOWFLAKE_PERMISSION_USER")
PERMISSION_BOT_PASSWORD = Secret("env", "PERMISSION_BOT_PASSWORD", "airflow", "SNOWFLAKE_PERMISSION_PASSWORD")
PERMISSION_BOT_ACCOUNT = Secret("env", "PERMISSION_BOT_ACCOUNT", "airflow", "SNOWFLAKE_ACCOUNT")
PERMISSION_BOT_DATABASE = Secret("env", "PERMISSION_BOT_DATABASE", "airflow", "SNOWFLAKE_PERMISSION_DATABASE")
PERMISSION_BOT_ROLE = Secret("env", "PERMISSION_BOT_ROLE", "airflow", "SNOWFLAKE_PERMISSION_ROLE")
PERMISSION_BOT_WAREHOUSE = Secret("env", "PERMISSION_BOT_WAREHOUSE", "airflow", "SNOWFLAKE_PERMISSION_WAREHOUSE")


# Diagnostic Locations
DIAGNOSTIC_LOCATION_ONE = Secret("env", "DIAGNOSTIC_LOCATION_ONE", "airflow", "DIAGNOSTIC_LOCATION_ONE")
DIAGNOSTIC_LOCATION_TWO = Secret("env", "DIAGNOSTIC_LOCATION_TWO", "airflow", "DIAGNOSTIC_LOCATION_TWO")
RELEASE_LOCATION = Secret("env", "RELEASE_LOCATION", "airflow", "RELEASE_LOCATION")

# Heroku
HEROKU_POSTGRESQL_URL = Secret("env", "HEROKU_POSTGRESQL_URL", "airflow", "HEROKU_POSTGRESQL_URL")
...
TWITTER_CONSUMER_SECRET = Secret("env", "TWITTER_CONSUMER_SECRET", "airflow", "TWITTER_CONSUMER_SECRET")
