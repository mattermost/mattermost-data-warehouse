...
from dags.kube_secrets import BLAPI_DATABASE_URL, BLAPI_TOKEN, BLAPI_URL
...
dag = DAG(
    "nightly_billing", default_args=default_args, schedule_interval="0 1 2-31 * *"
)
...
run_nightly_billing = KubernetesPodOperator(
    **pod_defaults,
    image=DATA_IMAGE,
    task_id="run-nightly-billing",
    name="run-nightly-billing",
    secrets=[BLAPI_DATABASE_URL, BLAPI_TOKEN, BLAPI_URL],
    env_vars=env_vars,
