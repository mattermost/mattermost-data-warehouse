...
WITH tva_bookings_new_and_exp_by_mo AS (
    SELECT
        ...
        round(((COALESCE(tva_bookings_new_by_mo.actual,0)+COALESCE(tva_bookings_exp_by_mo.actual,0))/bookings_new_and_exp_by_mo.target),2) AS tva,
        COALESCE(tva_bookings_new_by_mo.actual_oppt_less_than_5k,0) + COALESCE(tva_bookings_exp_by_mo.actual_oppt_less_than_5k,0) AS actual_oppt_less_than_5k
