...
WITH tva_attain_new_and_exp_by_rep_by_fy AS (
    SELECT
        REPLACE(target_slug,'_mo_','_fy_') AS target_slug,
        util.fiscal_year(tva_attain_new_and_exp_by_rep_by_mo.month) AS fy,
...
SELECT * FROM tva_attain_new_and_exp_by_rep_by_fy