...
WITH actual_arr_churn_by_mo AS (
    ...
    SELECT
        ...
        arr_churn_by_mo.month AS period_first_day,
        arr_churn_by_mo.month + interval '1 month' - interval '1 day' AS period_last_day,
        arr_churn_by_mo.target,
        actual_arr_churn_by_mo.total_arr AS actual,
        round((actual_arr_churn_by_mo.total_arr/arr_churn_by_mo.target),3) AS tva
