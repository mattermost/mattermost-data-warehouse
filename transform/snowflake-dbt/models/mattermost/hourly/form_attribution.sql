...
with website_visits_w_adgroup as (
    ...
    select marketo_forms.anonymous_id, marketo_forms.timestamp, marketo_forms.email, form_adgroup.campaignname, marketo_forms.context_page_path, marketo_forms.formid
    ...
    select forms_w_adgroup.anonymous_id, forms_w_adgroup.timestamp, forms_w_adgroup.EMAIL, forms_w_adgroup.context_page_path, forms_w_adgroup.formid, coalesce(forms_w_adgroup.campaignname, website_visits_w_adgroup.campaignname) as campaignname,
