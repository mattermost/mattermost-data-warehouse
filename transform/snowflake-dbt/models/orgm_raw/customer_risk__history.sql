...
SELECT DISTINCT o.id as sfid, coalesce(VARCHAR,NEWVALUE__FL::VARCHAR,NEWVALUE__ST::VARCHAR) as newvalue, coalesce(OLDVALUE__FL::VARCHAR,OLDVALUE__ST::VARCHAR) as oldvalue
