...
WITH account_renewal_rate_by_qtr AS (
    SELECT
        ...
        round(100*coalesce(least(available_renewals.available_renewals, sum(opportunitylineitem.renewal_amount__c))::float/available_renewals.available_renewals,0),2) AS account_renewal_rate_by_qtr,
