...
WITH master_account_monthly_arr_deltas_by_type AS (
    SELECT
        ...
        master_account_monthly_arr_deltas.account_sfid,
    ...
    FROM {{ ref('master_account_monthly_arr_deltas') }}
        LEFT JOIN {{ ref('master_account_daily_arr') }}
            ON master_account_monthly_arr_deltas.account_sfid = master_account_daily_arr.account_sfid AND master_account_monthly_arr_deltas.month_end = master_account_daily_arr.day
