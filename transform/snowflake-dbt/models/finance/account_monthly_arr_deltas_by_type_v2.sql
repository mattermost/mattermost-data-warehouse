...
WITH account_monthly_arr_deltas_by_type_v2 AS (
    SELECT
        ...
        CASE
            ...
            WHEN NOT account_new_arr AND month_starting_arr = 0 AND total_arr_delta > 0 THEN 'Resurrected ARR'
        ...
        sum(CASE WHEN NOT account_new_arr AND month_starting_arr = 0 AND total_arr_delta > 0 THEN total_arr_delta ELSE 0 END) AS total_arr_resurrected,
