...
WITH latest_credit_card_address AS (
    ...
    SELECT
        ...
        date(onprem_subscriptions.start_date) as start_date,
        date(onprem_subscriptions.end_date) as end_date,
        onprem_subscriptions.total_in_cents / 100.0 as total,
        date(onprem_subscriptions.updated_at) as updated_at,
        ...
        date(subscriptions.actual_renewal_date) as actual_renewal_date,
