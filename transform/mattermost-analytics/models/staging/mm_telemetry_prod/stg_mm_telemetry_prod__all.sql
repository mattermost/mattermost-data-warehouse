...
renamed as (
    select
        ...
        , config_ldap_enable_admin_filter
        , config_ldap_enable_sync
        ...
        , config_ldap_isdefault_group_display_name_attribute
        , config_ldap_isdefault_group_id_attribute
        ...
        , config_ldap_isdefault_login_field_name
        , config_ldap_isdefault_login_id_attribute
        ...
        , config_ldap_isempty_admin_filter
        , config_ldap_isempty_group_filter
        , config_ldap_isempty_guest_filter
        , config_ldap_isnotempty_picture_attribute
        , config_ldap_isnotempty_private_key
        , config_ldap_isnotempty_public_certificate
        , config_ldap_max_page_size
        , config_ldap_query_timeout                           as query_timeout_ldap
        , config_ldap_skip_certificate_verification
        , config_ldap_sync_interval_minutes

        -- Saml information
        , config_saml_enable                                  as enable_saml 
        , config_saml_enable_admin_attribute
        , config_saml_enable_sync_with_ldap
        , config_saml_enable_sync_with_ldap_include_auth
        , config_saml_encrypt                                 as encrypt_saml
        , config_saml_ignore_guests_ldap_sync
        , config_saml_isdefault_admin_attribute
        , config_saml_isdefault_canonical_algorithm
        ...
        , config_saml_isdefault_guest_attribute
        ...
        , config_saml_isdefault_locale_attribute
        ...
        , config_saml_isdefault_login_button_text
        ...
        , config_saml_isdefault_scoping_idp_name
        , config_saml_isdefault_scoping_idp_provider_id
        , config_saml_isdefault_signature_algorithm
        , config_saml_isdefault_username_attribute            as isdefault_username_attribute_saml
        , config_saml_sign_request
        , config_saml_verify                                  as verify_saml
        -- Plugin information
        , config_plugin_allow_insecure_download_url
        , config_plugin_automatic_prepackaged_plugins
        , config_plugin_chimera_oauth_proxy_url
        , config_plugin_enable                                as enable_plugin
        , config_plugin_enable_alertmanager
        , config_plugin_enable_antivirus
        ...
        , config_plugin_enable_bitbucket
        ...
        , config_plugin_enable_focalboard
        ...
        , config_plugin_enable_health_check
        ...
        , config_plugin_enable_jira
        , config_plugin_enable_jitsi
        , config_plugin_enable_marketplace
        ...
        , config_plugin_enable_nps_survey
        , config_plugin_enable_playbooks
        , config_plugin_enable_remote_marketplace
        , config_plugin_enable_ru_loop_plugin_embeds
        , config_plugin_enable_ru_loop_plugin_scheduler
        , config_plugin_enable_ru_loop_plugin_user_fields
        , config_plugin_enable_set_default_theme
        ...
        , config_plugin_enable_zoom
        , config_plugin_is_default_marketplace_url
        , coalesce(config_plugin_require_pluginsignature,
                   config_plugin_require_plugin_signature) as require_plugin_signature
        , config_plugin_signature_public_key_files
        , config_plugin_version_alertmanager
        , config_plugin_version_antivirus
        ...
        , config_plugin_version_bitbucket
        ...
        , config_plugin_version_focalboard
        ...
        , config_plugin_version_jira
        , config_plugin_version_jitsi
        ...
        , config_plugin_version_playbooks
        , config_plugin_version_set_default_theme
        ...
        , config_plugin_version_zoom
        -- Service information
        , config_service_allow_cookies_for_subdomains
        , config_service_allow_edit_post                              as allow_edit_post_service
        , config_service_allow_persistent_notifications
        , config_service_allow_persistent_notifications_for_guests
        , config_service_allow_synced_drafts
        , config_service_close_unused_direct_messages
        , config_service_cluster_log_timeout_milliseconds
        , config_service_collapsed_threads
        , config_service_connection_security                          as connection_security_service
        , config_service_cors_allow_credentials
        , config_service_cors_debug
        , config_service_custom_cert_header
        , config_service_default_team_name
        , config_service_developer_flags
        , config_service_disable_bots_when_owner_is_deactivated
        , config_service_disable_legacy_mfa
        , config_service_enable_api_channel_deletion
        , config_service_enable_api_post_deletion
        , config_service_enable_api_team_deletion
        , config_service_enable_api_trigger_admin_notification
        , config_service_enable_api_user_deletion
        , config_service_enable_bot_account_creation
        ...
        , config_service_enable_email_invitations
        , config_service_enable_emoji_picker                          as enable_emoji_picker_service
        , config_service_enable_file_search
        , config_service_enable_gif_picker
        ...
        , config_service_enable_legacy_sidebar
        , config_service_enable_link_previews
        , config_service_enable_local_mode
        ...
        , config_service_enable_onboarding_flow
        , config_service_enable_only_admin_integrations               as enable_only_admin_integrations_service

        , config_service_enable_opentracing
        , config_service_enable_outgoing_oauth_connections
        , config_service_enable_outgoing_webhooks
        , config_service_enable_permalink_previews
        , config_service_enable_post_icon_override
        , config_service_enable_post_search
        , config_service_enable_post_username_override
        , config_service_enable_preview_features
        , config_service_enable_security_fix_alert
        , config_service_enable_svgs
        , config_service_enable_testing
        , config_service_enable_tutorial
        , config_service_enable_user_access_tokens
        , config_service_enable_user_statuses
        , config_service_enable_user_typing_messages
        , config_service_enforce_multifactor_authentication           as enforce_multifactor_authentication_service
        , config_service_experimental_channel_organization
        , config_service_experimental_channel_sidebar_organization
        , config_service_experimental_data_prefetch
        , config_service_experimental_enable_authentication_transfer
        , config_service_experimental_enable_default_channel_leave_join_messages
        , config_service_experimental_enable_hardened_mode
        , config_service_experimental_group_unread_channels
        , config_service_experimental_strict_csrf_enforcement
        , config_service_extend_session_length_with_activity
        , config_service_forward_80_to_443
        , config_service_gfycat_api_key
        , config_service_gfycat_api_secret
        , config_service_isdefault_allowed_untrusted_internal_connections
        , config_service_isdefault_allow_cors_from
        , config_service_isdefault_cors_exposed_headers
        , config_service_isdefault_google_developer_key
        , config_service_isdefault_idle_timeout
        , config_service_isdefault_read_timeout
        , config_service_isdefault_site_url
        , config_service_isdefault_tls_cert_file
        , config_service_isdefault_tls_key_file
        , config_service_isdefault_write_timeout
        , config_service_limit_load_search_result
        , config_service_login_with_certificate
        , config_service_managed_resource_paths
        , config_service_maximum_login_attempts
        , config_service_maximum_payload_size
        , config_service_maximum_url_length
        , config_service_minimum_hashtag_length
        , config_service_outgoing_integrations_requests_timeout
        , config_service_persistent_notification_interval_minutes
        , config_service_persistent_notification_max_count
        , config_service_persistent_notification_max_recipients
        , config_service_post_edit_time_limit
        , config_service_post_priority
        , config_service_refresh_post_stats_run_time
        , config_service_restrict_custom_emoji_creation
        , config_service_restrict_link_previews
        , config_service_restrict_post_delete
        , config_service_self_hosted_expansion
        , config_service_self_hosted_purchase
        , config_service_session_cache_in_minutes
        , config_service_session_idle_timeout_in_minutes
        , config_service_session_length_mobile_in_days
        , config_service_session_length_mobile_in_hours
        , config_service_session_length_sso_in_days
        , config_service_session_length_sso_in_hours
        , config_service_session_length_web_in_days
        , config_service_session_length_web_in_hours
        , config_service_skip_login_page
        , config_service_terminate_sessions_on_password_change
        , config_service_thread_auto_follow
        , config_service_time_between_user_typing_updates_milliseconds
        , config_service_tls_strict_transport
        , config_service_uses_letsencrypt
        , config_service_websocket_url
        , config_service_web_server_mode
