...
with license_spine as (
    ...
    from
        ...
        left join {{ ref('stg_mm_telemetry_prod__license') }} as rudder_license on spine.license_id = rudder_license.license_id
        left join {{ ref('stg_mattermost2__license') }} as segment_license on spine.license_id = segment_license.license_id
