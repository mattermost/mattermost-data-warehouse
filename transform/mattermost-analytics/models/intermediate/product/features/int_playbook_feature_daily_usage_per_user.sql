...
select
    ...
    , user_id
    , event_name
    -- The following two columns are added in order to be consistent with mm_telemetry_prod.
    , null as category
    , null as event_type
    , 'Playbooks' as source
    , {{
...
{% endif %}
group by received_at_date, activity_date, server_id, user_id, event_name, category, event_type, source
