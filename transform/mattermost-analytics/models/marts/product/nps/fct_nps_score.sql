with nps_server_daily_score as (
    select {{ dbt_utils.generate_surrogate_key(['event_date', 'server_id', 'server_version', 'user_role']) }} as score_id
      ...
      , round(100.0 * ((promoters / nps_users) - (detractors / nps_users)),2) as nps_score
