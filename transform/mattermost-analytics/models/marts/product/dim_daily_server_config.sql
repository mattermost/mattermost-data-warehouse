...
select
    ...
    , coalesce(aallss.isdefault_locale_attribute, ss.isdefault_locale_attribute)                       as isdefault_locale_attribute
    ...
    , coalesce(aallss.isdefault_login_button_text, ss.isdefault_login_button_text)                       as isdefault_login_button_text
    , coalesce(aallss.isdefault_login_button_text_color_saml, ss.isdefault_login_button_text_color_saml) as isdefault_login_button_text_color_saml
    ...
    , coalesce(aallss.enable_aws_sns, ps.enable_aws_sns)                                             as enable_aws_sns
    ...
    , coalesce(alls.experimental_data_prefetch vs.experimental_data_prefetch)                          as experimental_data_prefetch
