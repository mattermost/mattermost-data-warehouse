...
WHEN NOT MATCHED THEN
    INSERT(date, server_id, user_id, feedback, category) values (recent_updates.date, recent_updates.server_id, recent_updates.user_id, recent_updates.feedback, recent_updates.category);
