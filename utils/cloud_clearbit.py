...
def cloud_clearbit():
    ...
    with engine.connect() as connection:
        ...
        try:
            query = f'''SELECT * FROM ANALYTICS.MATTERMOST.CLOUD_CLEARBIT limit 10'''
        ...
        if len(cloud_clearbit) >= 1:
            ...
            with engine.connect() as connection:
                ...
                clearbit_df2.to_sql("cloud_clearbit", con=connection, index=False, schema="MATTERMOST", if_exists="append", chunksize=5000)
